...
As we have mentioned in the beginning of this section, by choosing the size of bands and rows appropriately we augment the number of false positives, documents that have very little in common and are checked, or the number of false negatives, documents that have a lot in common but are not checked. 
